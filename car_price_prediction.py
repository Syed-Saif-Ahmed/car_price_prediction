...
"""
    ...
    p2 = st.selectbox("What is the prefered Aspiration (i.e., Initial combustion of engine):", ('standard','turbo'))
    ...
    p5 = st.selectbox("What is the prefered Drive Wheel ? ", ('four-wheel','front-wheel','rear-wheel'))
    ...
    p8 = st.selectbox("Prefered engine type ? : ",('double-overhead-camshaft','double-overhead-camshaft-with-variable-value-timing', 
         'smaller', 'overhead-camshaft', 'overhead-value-camshaft, Fork operated','overhead-camshaft-value',
         'rotary-engine'))
...
def code_p8(p8):
    d = {'dohc' : 'double-overhead-camshaft','dohcv' : 'double-overhead-camshaft-with-variable-value-timing', 
         'l' : 'smaller', 'ohc' : 'overhead-camshaft', 'ohcf' : 'overhead-value-camshaft, Fork operated','ohcv' : 'overhead-camshaft-value',
         'rotor' : 'rotary-engine'}
    p8 = get_key_by_value(d,p8)
...
def code_p5(p5):
    d = {'4wd': 'four-wheel', 'fwd' : 'front-wheel','rwd' : 'rear-wheel'}
    p5 = get_key_by_value(d,p5)
    d = {0: '4wd', 1: 'fwd', 2: 'rwd'} 
...
def code_p2(p2):
    d = {'std' : 'standard', 'turbo' : 'turbo'}
    p2 = get_key_by_value(d,p2)
    d = {0: 'std', 1: 'turbo'} 
